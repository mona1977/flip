...
/*
   ...
   Date : 13-JAN-2020
   OBJECTIVE : GET and save data using API CONNECTION
*/
//connect Database
...
//List data
   ...
   //display records
	function listdataDetail($transaction_id)
	{
		$header = array(
			"Content-Type: application/x-www-form-urlencoded",
		);
   ...
   //API connection details for get data
    ...
    //API connection details for POST data
